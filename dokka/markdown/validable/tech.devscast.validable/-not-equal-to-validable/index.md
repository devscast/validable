//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[NotEqualToValidable](index.md)

# NotEqualToValidable

class [NotEqualToValidable](index.md)(comparedValue: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [NotEqualToValidable](-not-equal-to-validable.md) | [androidJvm]<br>constructor(comparedValue: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
