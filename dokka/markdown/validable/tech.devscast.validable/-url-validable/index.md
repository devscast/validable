//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[UrlValidable](index.md)

# UrlValidable

class [UrlValidable](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [UrlValidable](-url-validable.md) | [androidJvm]<br>constructor(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
