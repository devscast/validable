//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[NegativeValidable](index.md)

# NegativeValidable

class [NegativeValidable](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [NegativeValidable](-negative-validable.md) | [androidJvm]<br>constructor(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
