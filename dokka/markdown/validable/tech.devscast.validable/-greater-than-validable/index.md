//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[GreaterThanValidable](index.md)

# GreaterThanValidable

class [GreaterThanValidable](index.md)(comparedValue: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [GreaterThanValidable](-greater-than-validable.md) | [androidJvm]<br>constructor(comparedValue: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
