//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[PositiveOrZeroValidable](index.md)

# PositiveOrZeroValidable

class [PositiveOrZeroValidable](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [PositiveOrZeroValidable](-positive-or-zero-validable.md) | [androidJvm]<br>constructor(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
