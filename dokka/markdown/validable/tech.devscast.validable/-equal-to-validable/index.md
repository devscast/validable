//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[EqualToValidable](index.md)

# EqualToValidable

class [EqualToValidable](index.md)(comparedValue: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [EqualToValidable](-equal-to-validable.md) | [androidJvm]<br>constructor(comparedValue: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html), message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
