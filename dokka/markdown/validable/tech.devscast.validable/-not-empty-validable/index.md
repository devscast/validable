//[validable](../../../index.md)/[tech.devscast.validable](../index.md)/[NotEmptyValidable](index.md)

# NotEmptyValidable

class [NotEmptyValidable](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) : [BaseValidable](../-base-validable/index.md)
...
| | |
|---|---|
| [NotEmptyValidable](-not-empty-validable.md) | [androidJvm]<br>constructor(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)? = null) |
